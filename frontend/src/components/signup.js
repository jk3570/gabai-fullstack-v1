                ...
                <p>Register now for a richer, more empowered journey!</p>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="" style={{ display: 'flex', justifyContent: 'space-between' }}>
                       ...
                       <a href="#" className="w-24 text-center bg-azure-500 text-white  rounded-xl p-2 " onClick={prevStep} style={{ alignSelf: 'flex-end' }}>Previous</a>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p>Register now for a richer, more empowered journey!</p>
                    ...
                    <div className="flex flex-col py-3">
                      ...
                      <br/>
                      <div className="" style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <a href="#" className="px-2 py-2 text-lg text-center text-white bg-azure-500 rounded-lg" onClick={prevStep}>Previous</a>
                      <br/>
                      <button type="submit" className="w-48 px-2 py-2 bg-azure-500 text-white font-bold rounded-xl p-2" disabled={error || isLoading || passwordMatchError}>
                        Sign Up Now!
                      </button>
                      </div>
